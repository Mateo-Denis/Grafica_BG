...
public class CodingErrorPdfInvoiceCreator {
    ...
    public   void createTnc(List<String> TncList,Boolean lastPage,String imagePath) {
        if(lastPage) {
            ...
            for (String tnc : TncList) {
                ...
                tb.addCell(new Cell().add(tnc).setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER));
            }
    ...
    public void createProduct(List<Product> productList, float totalPrice) {
        ...
        for (Product product:productList)
        {
            ...
            threeColTable2.addCell(new Cell().add(String.valueOf(product.getDimensions())).setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER));
            threeColTable2.addCell(new Cell().add(String.valueOf(product.getPriceperpeice())).setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER));
            //threeColTable2.addCell(new Cell().add(String.valueOf(product.getTotal())).setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER));
            threeColTable2.addCell(new Cell().add(String.valueOf(product.getTotal()/*total*/)).setTextAlignment(TextAlignment.RIGHT).setBorder(Border.NO_BORDER)).setMarginRight(15f);
        }
        ...
        threeColTable3.addCell(new Cell().add(String.valueOf(totalPrice)).setTextAlignment(TextAlignment.RIGHT).setBorder(Border.NO_BORDER)).setMarginRight(15f);
    ...
    public void createTableHeader(ProductTableHeader productTableHeader) {
        ...
        threeColTable1.addCell(new Cell().add("Descripción").setBold().setFontColor(Color.WHITE).setBorder(Border.NO_BORDER));
        threeColTable1.addCell(new Cell().add("Cantidad").setBold().setFontColor(Color.WHITE).setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER));
        threeColTable1.addCell(new Cell().add("Dimensiones").setBold().setFontColor(Color.WHITE).setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER));
        threeColTable1.addCell(new Cell().add("Precio").setBold().setFontColor(Color.WHITE).setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER));
        threeColTable1.addCell(new Cell().add("Total").setBold().setFontColor(Color.WHITE).setTextAlignment(TextAlignment.RIGHT).setBorder(Border.NO_BORDER)).setMarginRight(15f);
