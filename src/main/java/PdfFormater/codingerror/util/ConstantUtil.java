package PdfFormater.codingerror.util;
...
public class ConstantUtil {
    ...
    public   static final  String PRODUCT_TABLE_DIMENSIONS = "Dimensiones";
    public   static final  String PRODUCT_TABLE_TOTAL = "Total";
